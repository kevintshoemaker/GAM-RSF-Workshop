---
title: "Welcome to TWS-WS GAMs Workshop"
author: "Non-linear habitat modeling using telemetry data"
date: "Feb 2, 2026"
output:
  html_document:
    theme: cosmo
...
## Main slide deck for workshop

[https://docs.google.com/presentation/d/1FPGMNagm7GfJtPSoGQAdLmr__fLx5E-0rFVibfHEHYU/edit?usp=sharing](https://docs.google.com/presentation/d/1FPGMNagm7GfJtPSoGQAdLmr__fLx5E-0rFVibfHEHYU/edit?usp=sharing)

## Course Materials (GitHub)

[https://github.com/kevintshoemaker/GAM-RSF-Workshop](https://github.com/kevintshoemaker/GAM-RSF-Workshop)

Download course materials by clicking on the green "Code" button and downloading the repository as a zipfile. Unzip all the workshop materials to the root folder of the RStudio Project for this workshop. 

## Course Materials (Google Drive)

See email for link -- download materials as ZIPfile and unzip to the RStudio Project Directory.

## Intro to GAM slides (Gavin Simpson)

[Intro to GAM slides](https://fromthebottomoftheheap.net/slides/gams-webinar-efi-esa-2022/gams.html#37)


## GAM worked examples

### Splines intro (tent spline)

[Tent splines demo](splines_demo.R)

### Time series example 

[Arthropod example (time series)](code/arthropod.R)        
[Arthropod data](data/25786_3_data.csv)      

### Spatial data, presence/absence

[Lark example (presence absence)](code/lark.R)

### Spatial data, presence only

[Joshua tree example](code/joshua-tree.R)     
[Joshua tree data](data/joshua-tree.txt)     
...
## Intro to sdmTMB slides (Sean Anderson et al.)

[all sdmTMB teaching materials](https://sdmtmb.github.io/sdmTMB-teaching/amaremed-2024/index.html)         

[Intro to random fields](https://sdmtmb.github.io/sdmTMB-teaching/amaremed-2024/01-intro-random-fields.html#1)      

[modeling presence only data using randomized background points](https://sdmtmb.github.io/sdmTMB-teaching/noaa-psaw-2022/06-presence-only.html#1)

## sdmTMB exercise

[sdmTMB exercise](code/sdmTMB_exercise1.R)       
